...
public interface JavaParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link JavaParser#ifbranch}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfbranch(JavaParser.IfbranchContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaParser#elseif}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitElseif(JavaParser.ElseifContext ctx);
	/**
